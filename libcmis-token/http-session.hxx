...
class HttpSession
{
    ...
    public:
		...
		void setNeedProgressValue(bool bNeedProgress) { m_bNeedProgress = bNeedProgress; };

		void setProgressCallBack(progressCallback pCallback) { m_pProgressCallBack = pCallback; };
